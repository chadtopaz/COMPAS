...
whitelist[[5]] <- expand.grid("Judge.Name", "prison")
whitelist[[6]] <- expand.grid(chargevars, compasvars)
whitelist[[7]] <- expand.grid(chargevars, "Public.Defender.")
...
blacklist[[5]] <- NULL#expand.grid(chargevars, compasvars)
...
blacklist[[13]] <- NULL#expand.grid("Judge.Name", "Public.Defender.")
...
blacklist[[22]] <- expand.grid(chargevars, "Judge.Name")
